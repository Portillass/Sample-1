...
<head>
  ...
  <!-- Fix the asset paths using asset() helper -->
          ...
          <ul id="sidebarnav">
            <li class="nav-small-cap">
              ...
              <span class="hide-menu">Home</span>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="{{ route('enrollment.create') }}" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="{{ route('enrollments.index') }}" aria-expanded="false">
                        ...
                        <span class="hide-menu">Student Table</span>
                    </a>
                </li>
                <li class="sidebar-item">
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#headerCollapse').on('click', function() {
        $('.left-sidebar').toggleClass('collapse');
      });
    });
  </script>
